...
// Set the Options Array
        ...
        $of_options[] = array( "name" => "Copyright Text",
            ...
            "id" => "footer_text",
            "std" => 'Copyright 2015 Fine Interior| All Rights Reserved | Powered by <a href="http://wordpress.org">WordPress</a>  ',
            "type" => "textarea");
...
// Theme Specific Options
        ...
        $of_options[] = array( "name" => "Google Maps Geocoding API Key",
            "desc" => "<a href='http://theme-fusion.com/knowledgebase/registering-google-map-api-key/'>Click here to learn how to register an API key</a>.",
        ...
        $of_options[] = array( "name" => "Disable Open Graph",
            "desc" => "Check the box to disable open graph.",
            "id" => "status_opengraph",
            "std" => 0,
            "type" => "checkbox");            
